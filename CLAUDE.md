...
- `dist-workspace.toml` configures cargo-dist v0.31.
...
- Homebrew formula auto-publishes to `EricBriscoe/homebrew-clidirstat` via
  the `HOMEBREW_TAP_TOKEN` secret (PAT with `repo` scope).
